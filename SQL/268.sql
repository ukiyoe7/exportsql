EXECUTE BLOCK RETURNS (
         ...
         PEDDTEMIS DATE,
         PEDCODIGO VARCHAR(150),
         PEDPZENTRE DATE,
         PEDHRENTRE TIME,
         PEDDTSAIDA DATE,
         CLICODIGO INT,
         ENDCODIGO VARCHAR(150),
         ...
         PEDPZETGSIS DATE,
         JBCODIGO INT,
         CORDESCRICAO VARCHAR(150),
         LPDESCRICAO VARCHAR(150),
         PEDIDO VARCHAR(50),
         LPCODIGO VARCHAR(50),
...
WHERE PED.PEDDTEMIS BETWEEN '01.05.2023' AND 'TODAY'
